...
import com.nurio.android.bridge.PaymentRecoveryComponent
...
class NurioApplication : Application() {
    override fun onCreate() {
        super.onCreate()
        PaymentRecovery.initialize(this, BuildConfig.BASE_URL)
    ...
    private fun configureHotwire() {
        ...
        Hotwire.registerBridgeComponents(
            ...
            BridgeComponentFactory("payment-recovery", ::PaymentRecoveryComponent),
