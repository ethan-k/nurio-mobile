...
-keep class com.nurio.study.android.fragments.** { *; }
-keep @dev.hotwire.navigation.destinations.HotwireDestinationDeepLink class com.nurio.study.android.fragments.** { *; }
