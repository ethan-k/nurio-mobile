...
import com.nurio.studyleaders.android.notifications.PushRegistrationError
import com.nurio.studyleaders.android.notifications.PushRegistrationResult
...
class RegisterDeviceTokenComponent(
    ...
    companion object {
        private const val TAG = "LeaderPushBridge"
    }
}
