...
import com.nurio.studyleaders.android.R

class StudyLeaderFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onNewToken(token: String) {
        Log.d(TAG, "Study Leader FCM token refreshed")
    }
    ...
    private fun showNotification(title: String, body: String, destination: String, tag: String) {
        ...
        try {
            ...
            Log.w(TAG, "Study Leader notification permission is unavailable")
        }
    }

    companion object {
        private const val TAG = "LeaderFCM"
    }
}
