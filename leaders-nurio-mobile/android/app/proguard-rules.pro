...
-keep class com.nurio.studyleader.android.fragments.** { *; }
-keep @dev.hotwire.navigation.destinations.HotwireDestinationDeepLink class com.nurio.studyleader.android.fragments.** { *; }
