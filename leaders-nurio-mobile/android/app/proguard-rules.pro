...
-keep class com.nurio.studyleaders.android.fragments.** { *; }
-keep @dev.hotwire.navigation.destinations.HotwireDestinationDeepLink class com.nurio.studyleaders.android.fragments.** { *; }
